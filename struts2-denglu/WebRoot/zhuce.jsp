...
<html>
  ...
  <body>
   ...
   <form action="uu.action" method="post"> 
     
    <table width="393" border="0" align="center" style="margin-top:200px">
  <tr align="center" valign="middle">
    <td height="77" colspan="2">欢迎注册我的网站</td>
    </tr>
  <tr>
  ...
  <tr>
    <td height="92"><input type="submit" value="注册" style="margin-left:80px"></td>
    <td><input type="button" onclick="location.href='index.jsp'" value="返回" style="margin-left:50px" ></td>
  </tr>
